...
void GenerateTextures()
{
	...
	// wczytanie tekstury old-wood-texture.tga
	error = load_targa("old-wood-texture.tga", width, height, format, type, pixels);
	//wall_wood_verti_color.tga
	// błąd odczytu pliku
	if (error == GL_FALSE)
	{
		printf("Niepoprawny odczyt pliku old-wood-texture.tga");
		//exit(0);
	}
...
void GenerateDisplayLists()
{
	...
	//// prawa boczna ściana
	glTexCoord2f(0.0, 1.0);
	glVertex3f(1.0001, 1.0, -1.01);

	glTexCoord2f(2.0, 1.0);
	glVertex3f(1.0001, 1.0, 1.01);

	glTexCoord2f(2.0, 0.0);
	glVertex3f(1.0001, -0.0, 1.01);
